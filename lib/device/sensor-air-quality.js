...
export default class {
  constructor(platform, accessory) {
    ...
    // Add a virtual 'Auto AC' switch (state held locally, persisted via the accessory cache)
    this.autoACService = this.accessory.getServiceById(this.hapServ.Switch, 'autoac')
      || this.accessory.addService(this.hapServ.Switch, 'Auto AC', 'autoac')
    this.autoACService.getCharacteristic(this.hapChar.On).onSet((value) => {
