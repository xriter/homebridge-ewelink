  ...
  async initialiseDevice(device) {
    try {
      ...
      if (platformConsts.devices.switchMultiPower.includes(uiid) && device.params.workMode === 2) {
        ...
        // Standalone 'Auto AC' accessory: holds the auto toggle and the AC-speed trigger sensors.
        ...
        accessory.control = new deviceTypes.deviceSensorAirQuality(this, accessory, acAcc)
        /** */
